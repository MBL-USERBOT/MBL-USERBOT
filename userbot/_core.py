...
from userbot.utils import mbl_cmd, load_module, remove_plugin
...
thumb_image_path = "./Resources/IMG-20201216-WA0001.jpg"
...
@bot.on(mbl_cmd(pattern="install"))
...
@bot.on(mbl_cmd(pattern=r"unload (?P<shortname>\w+)$"))
...
@bot.on(mbl_cmd(pattern=r"load (?P<shortname>\w+)$"))
