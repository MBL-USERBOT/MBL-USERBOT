...
@borg.on(mbl_cmd(pattern=r"promote(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"demote(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"unban(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"mute(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"unmute(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"ungmute(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"gmute(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"delusers(?: |$)(.*)"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"adminlist"))
@errors_handler
...
@borg.on(mbl_cmd(pattern=r"kick(?: |$)(.*)"))
@errors_handler
async def kick(usr):
...
@borg.on(mbl_cmd(pattern=r"users ?(.*)"))
@errors_handler
