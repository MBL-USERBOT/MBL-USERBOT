...
@borg.on(mbl_cmd(pattern=r"clock"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🕛🕐🕑🕒🕓🕔🕕🕖🕗🕘🕙🕚"))
...
@borg.on(mbl_cmd(pattern="stupid$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"bombs$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"kill$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"hypno$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern="gangasta$"))
async def _(event):
...
@borg.on(mbl_cmd(pattern=f"charging$"))
...
@borg.on(mbl_cmd(outgoing=True, pattern="clock$"))
async def _(event):
	    if event.fwd_from:
		    return
	    deq = deque(list("🕙🕘🕗🕖🕕🕔🕓🕒🕑🕐🕛"))
...
@borg.on(mbl_cmd(pattern="gym$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🏃‍🏋‍🤸‍🏃‍🏋‍🤸‍🏃‍🏋‍🤸‍"))
...
@borg.on(mbl_cmd(pattern=f"earth$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🌏🌍🌎🌎🌍🌏🌍🌎"))
...
@borg.on(mbl_cmd(outgoing=True, pattern="moon$"))
async def _(event):
	    if event.fwd_from:
		    return
	    deq = deque(list("🌗🌘🌑🌒🌓🌔🌕🌖"))
...
@borg.on(mbl_cmd(pattern=f"smoon$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@borg.on(mbl_cmd(pattern=f"tmoon$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@borg.on(mbl_cmd(pattern=f"clown$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=r"star$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🦋✨🦋✨🦋✨🦋✨"))
...
@borg.on(mbl_cmd(pattern=r"boxs"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🟥🟧🟨🟩🟦🟪🟫⬛⬜"))
...
@borg.on(mbl_cmd(pattern=f"rain$", outgoing=True))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🌬☁️🌩🌨🌧🌦🌥⛅🌤"))
...
@borg.on(mbl_cmd(pattern=r"clol$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🤔🧐🤨🤔🧐🤨"))
...
@borg.on(mbl_cmd(pattern=r"odra$"))
async def _(event):
	if event.fwd_from:
		return
	deq = deque(list("🚶🏃🚶🏃🚶🏃🚶🏃"))
...
@borg.on(mbl_cmd(pattern="fleaveme$"))
async def _(event):
    animation_interval = 1
...
@borg.on(mbl_cmd(pattern=f"plane", outgoing=True))
async def _(event):
    if event.fwd_from:
        retun
    await event.edit("✈-------------")
...
@borg.on(mbl_cmd(pattern=r"police"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"jio$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(mbl_cmd(pattern=f"solarsystem", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.1
...
@borg.on(mbl_cmd(pattern=f"snake$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"human$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"show$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"isro$"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(mbl_cmd(pattern=f"music$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"squ$",outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"loading$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"square$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"up$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"round$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=f"hart$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
...
@borg.on(mbl_cmd(pattern=f"anim$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(mbl_cmd(pattern=f"fnl$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern=f"monkey$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(mbl_cmd(pattern=f"herber$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(mbl_cmd(pattern=f"hand$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(mbl_cmd(pattern=f"gsg$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(mbl_cmd(pattern=r"theart$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(mbl_cmd(pattern=r"fdance"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(mbl_cmd(outgoing=True, pattern="kf$(.*)"))
async def _(event):                             
