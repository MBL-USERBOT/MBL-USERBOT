...
@borg.on(mbl_cmd(pattern=r"monster"))
async def bluedevilmonster(monster):
    await monster.edit(M)
@borg.on(mbl_cmd(pattern=r"pig"))
async def bluedevilpig(pig):
    await pig.edit(P)
@borg.on(mbl_cmd(pattern=r"kiler"))
async def bluedevilkiller(kiler):
    await kiler.edit(K)
@borg.on(mbl_cmd(pattern=r"gun"))
async def bluedevilgun(gun):
    await gun.edit(G)
@borg.on(mbl_cmd(pattern=r"dog"))
async def bluedevildog(dog):
    await dog.edit(D)    
@borg.on(mbl_cmd(pattern=r"hello"))
async def bluedevilhello(hello):
    await hello.edit(H)
@borg.on(mbl_cmd(pattern=r"hmf"))
