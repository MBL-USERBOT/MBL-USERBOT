...
@borg.on(mbl_cmd(pattern="purl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
...
@borg.on(mbl_cmd(pattern="sgm ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@borg.on(mbl_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@borg.on(mbl_cmd(pattern="connecter ?(.*)", allow_sudo=True))
async def _(event):
  if event.fwd_from:
    return
  if event.is_private:
