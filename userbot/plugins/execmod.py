...
@borg.on(mbl_cmd(outgoing=True, pattern="pips(?: |$)(.*)"))
...
@borg.on(mbl_cmd(pattern="suicide$"))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern="plugins$"))
async def _(event):
    if event.fwd_from:
        return
    DELAY_BETWEEN_EDITS = 0.3
...
@borg.on(mbl_cmd(pattern="fortune$"))
async def _(event):
    if event.fwd_from:
        return
    DELAY_BETWEEN_EDITS = 0.3
...
@borg.on(mbl_cmd(pattern="qquote$"))
async def _(event):
    if event.fwd_from:
        return
    DELAY_BETWEEN_EDITS = 0.3
...
@borg.on(mbl_cmd(pattern="fakeid$"))
async def _(event):
    if event.fwd_from:
        return
    DELAY_BETWEEN_EDITS = 0.3
