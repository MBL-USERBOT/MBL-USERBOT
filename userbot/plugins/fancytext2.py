...
@borg.on(mbl_cmd(pattern="fgd ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("╔═╗───────╔╗ ─╔╗────╔╦╗\n║╬║╔═╗╔═╗╔╝║ ╔╝║╔═╗─║║║\n╠╗║║╬║║╬║║╬║ ║╬║║╬╚╗╠╗║\n╚═╝╚═╝╚═╝╚═╝ ╚═╝╚══╝╚═╝")

@borg.on(mbl_cmd(pattern="noice ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("╔═╦╗╔══╗╔═╗╔═╗\n║║║║╚║║╝║╔╝║╦╝\n║║║║╔║║╗║╚╗║╩╗\n╚╩═╝╚══╝╚═╝╚═╝")

@borg.on(mbl_cmd(pattern="really ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("╔═╗╔═╗╔══╗╔╗─╔╗─╔═╦╗\n║╬║║╦╝║╔╗║║║─║║─╚╗║║\n║╗╣║╩╗║╠╣║║╚╗║╚╗╔╩╗║\n╚╩╝╚═╝╚╝╚╝╚═╝╚═╝╚══╝")

@borg.on(mbl_cmd(pattern="ooh ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("╔═╗╔═╗╔═╗╔╗╔╗\n║║║║║║║║║║╚╝║\n║║║║║║║║║║╔╗║\n╚═╝╚═╝╚═╝╚╝╚╝")

@borg.on(mbl_cmd(pattern="maker ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("╔══╗╔══╗╔╦═╦╗╔══╗╔═╦╗\n║══╣║╔╗║║║║║║║╔╗║║║║║\n╠══║║╠╣║║║║║║║╠╣║║║║║\n╚══╝╚╝╚╝╚═╩═╝╚╝╚╝╚╩═╝")

@borg.on(mbl_cmd(pattern="pgl ?(.*)"))
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        await event.edit("╔═╗╔══╗╔══╗╔══╗╔╗─\n║╬║║╔╗║║╔═╣║╔╗║║║─\n║╔╝║╠╣║║╚╗║║╠╣║║╚╗\n╚╝─╚╝╚╝╚══╝╚╝╚╝╚═╝")
