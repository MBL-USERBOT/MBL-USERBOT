...
from userbot.utils import mbl_cmd, progress, humanbytes
...
@borg.on(mbl_cmd(pattern="gdrive ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern="dfolder https?://drive\.google\.com/drive/u/\d/folders/([-\w]{25,})", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern="gclear", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(mbl_cmd(pattern="gdir ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(mbl_cmd(pattern="drive (delete|get) ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
...
@borg.on(mbl_cmd(pattern="sdrive ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mone = await event.reply("Processing ...")
