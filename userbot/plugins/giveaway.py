...
@borg.on(mbl_cmd(pattern="forward ?(.*)"))
...
@borg.on(mbl_cmd(pattern="broadcast ?(.*)"))
...
@borg.on(mbl_cmd(pattern="addchannel ?(.*)"))
...
@borg.on(mbl_cmd(pattern="rmchannel ?(.*)"))
...
@borg.on(mbl_cmd(pattern="listchannels"))
...
@borg.on(mbl_cmd(pattern="search ?(.*)"))
