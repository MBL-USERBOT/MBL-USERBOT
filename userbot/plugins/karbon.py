...
@borg.on(mbl_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
...
@borg.on(mbl_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
async def carbon_api(e):
   """ A Wrapper for carbon.now.sh """
   await e.edit("📛📛📛📛📛")
...
@borg.on(mbl_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
async def carbon_api(e):
   """ A Wrapper for carbon.now.sh """
   await e.edit("🎛🎛🎛🎛🎛")
...
@borg.on(mbl_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
async def carbon_api(e):
   """ A Wrapper for carbon.now.sh """
   await e.edit("🌚🌚🌚🌚🌚")
...
@borg.on(mbl_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
async def carbon_api(e):
...
@borg.on(mbl_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
async def carbon_api(e):
   RED = random.randint(0,256)
   GREEN = random.randint(0,256)
   BLUE = random.randint(0,256)
...
"""
@borg.on(mbl_cmd(pattern=f"karpp", allow_sudo=True))
