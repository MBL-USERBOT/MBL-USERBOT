...
@borg.on(mbl_cmd(pattern=r"macos"))
...
@borg.on(mbl_cmd(pattern=r"windows"))
...
@borg.on(mbl_cmd(pattern=r"linux"))
...
@borg.on(mbl_cmd(pattern=r"stock"))
