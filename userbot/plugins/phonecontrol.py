...
@borg.on(mbl_cmd(pattern="battery ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
...
@borg.on(mbl_cmd(pattern="pmute ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@borg.on(mbl_cmd(pattern="pring ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
...
@borg.on(mbl_cmd(pattern="pvibrate ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    if not event.reply_to_msg_id:
