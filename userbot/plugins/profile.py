...
@borg.on(mbl_cmd(pattern="pbio (.*)"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(pattern="ppic"))  # pylint:disable=E0602
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(mbl_cmd(outgoing=True, pattern="username (.*)"))
...
@borg.on(mbl_cmd(outgoing=True, pattern="count$"))
...
@borg.on(mbl_cmd(outgoing=True, pattern=r"delpfp"))
...
@borg.on(mbl_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
