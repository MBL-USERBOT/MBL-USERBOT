...
async def lolmetrg(event):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"rmbow"))
async def lolmetrg(event):
    await event.delete()
    sed = await event.get_reply_message()
    if isinstance(sed.media, MessageMediaPhoto):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"glass"))
async def lolmetrg(event):
    await event.delete()
    sed = await event.get_reply_message()
    if isinstance(sed.media, MessageMediaPhoto):
...
async def lolmetrg(event):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"invert"))
async def lolmetrg(event):
    await event.delete()
    sed = await event.get_reply_message()
    if isinstance(sed.media, MessageMediaPhoto):
...
async def lolmetrg(event):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"brght"))
async def lolmetrg(event):
...
async def lolmetrg(event):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"sepia"))
async def lolmetrg(event):
    await event.delete()
    sed = await event.get_reply_message()
    if isinstance(sed.media, MessageMediaPhoto):
...
async def lolmetrg(event):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"green"))
async def lolmetrg(event):
    await event.delete()
    sed = await event.get_reply_message()
    if isinstance(sed.media, MessageMediaPhoto):
...
async def lolmetrg(event):
    ...
    for files in (lolbruh, img):
        if files and os.path.exists(files):
            os.remove(files)
@bot.on(mbl_cmd(pattern=r"pixlte"))
async def lolmetrg(event):
    await event.delete()
    sed = await event.get_reply_message()
    if isinstance(sed.media, MessageMediaPhoto):
